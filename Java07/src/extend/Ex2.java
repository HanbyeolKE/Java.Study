...
public class Ex2 {
	public static void main(String[] args) {
		// 상속 : 낸눈에는 안보이지만 컴퓨터가 클래스를 복사붙여넣기를 하게 한다
...
class Member extends Person{
	...
	// 상속 받은 다음 수정하는 법 : 오버라이딩
	// 오버라이딩 : 물려받은 메서드를 재정의(다시만든다)
	public void 정보보기() {
		super.정보보기();		// super. :  상속해준 클래스의 정보보기를 사용
		// this. : 나, super. : 부모
		System.out.println("회원그룹은 "+그룹명);
		
		// 오버라이딩(수정) : 부모의 것과 나의 것이 곂치면 나의 것이 '우선순위' 가 더 높다.
	}
